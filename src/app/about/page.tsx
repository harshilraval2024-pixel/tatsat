...
export const metadata: Metadata = {
  title: "About us",
  description: `Learn about ${site.name} — mission, vision, and how we deliver rooftop solar across India with a Gujarat-first operations hub.`,
};
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
      <SectionHeading
        ...
        subtitle={`${site.name} exists to make high-yield rooftop solar boringly reliable — from subsidy paperwork to monsoon-ready cable routing.`}
      />
